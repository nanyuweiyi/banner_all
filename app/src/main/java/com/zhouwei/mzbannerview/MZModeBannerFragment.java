...
import com.zhouwei.mzbannerview.img.ImgUtil;
...
//    public static final int []BANNER = new int[]{R.mipmap.banner1,R.mipmap.banner2,R.mipmap.banner3,R.mipmap.banner4,R.mipmap.banner5};
    public static final String []RES = new String[]{"http://img1.imgtn.bdimg.com/it/u=4027212837,1228313366&fm=23&gp=0.jpg", "https://raw.githubusercontent.com/sfsheng0322/GlideImageView/master/screenshot/cat.jpg"};
    public static final String []BANNER = new String[]{"https://raw.githubusercontent.com/sfsheng0322/GlideImageView/master/screenshot/cat.jpg", "http://img1.imgtn.bdimg.com/it/u=4027212837,1228313366&fm=23&gp=0.jpg"};
...
//            mImageView.setImageResource(data);
            ImgUtil.displayImage(mImageView, data);
        }
    }
    @Nullable
    @Override
